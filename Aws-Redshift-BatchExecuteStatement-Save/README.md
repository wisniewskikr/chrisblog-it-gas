AWS REDSHIFT BATCH EXECUTE STATEMENT SAVE
=========================================
...
* **Gsheet URL**: https://docs.google.com/spreadsheets/d/1aXYBYV3JrZzsmkmShMBWhsgrMHyvXIoC775vj7Z5l6U/edit?usp=sharing
...
##### Goal
The goal of this project is to show how to connect Gsheet with AWS Redshifd and run some batch execute statement. This batch execute statement enables to run read and write data to and from table.
