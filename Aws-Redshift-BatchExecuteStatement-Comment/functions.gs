...
function exportFunction() {
  ...
  var id = spreadsheet.getRange('A2').getValue();
  var message = spreadsheet.getRange('B2').getValue();
  var sql = `/* user X */ INSERT INTO public.greetings (id, message) VALUES (${id}, '${message}')`;
...
function importFunction() {
  ...
  var sql = "/* user Y */ select * from GREETINGS ORDER BY id DESC LIMIT 1";
